...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/secret/library/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/secret/library/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">

	<link href="<?php echo base_url();?>assets/new-capture-page-assets/secret/style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/secret/css/custom-style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/secret/css/media-queries.css" rel="stylesheet">
</head>
<body>
	...
	<input type="hidden" value="<?php echo $id;?>" name="member_id" id="member_id">
            <div class="content_holder"><!-- Begin content -->
				...
				<div class="row-fluid">
					...
					<div class="span5">
						<img src="<?php echo base_url();?>assets/new-capture-page-assets/secret/images/top-secret.jpg" alt="top secret">
...
<script src="<?php echo base_url();?>assets/new-capture-page-assets/secret/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url();?>assets/new-capture-page-assets/secret/library/bootstrap/js/bootstrap.min.js"></script>
