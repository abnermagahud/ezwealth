...
<head>
    ...
    <title>E-Wallet | Administration Panel</title>
      ...
      <a href="<?php echo base_url();?>admin/loggedout/">Logout</a>
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="<?php echo base_url();?>admin/ewallet/">E-WALLET</a></li>
                   <li class="dropdown">
                           ...
                           <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(!empty($getAllMembers)){
										...
										foreach($getAllMembers as $mem){
											$mem_lname = $mem->lastname;
											$mem_fname = $mem->firstname;
											$mem_full_name = $mem_fname . ' '.$mem_lname; 
                      $converted = $mem->converted_amount;
										
									?>
                                        <tr class="odd gradeX">
                                            
                                            <td><?php echo ucwords($mem_full_name);?></td>
                                            <td><?php echo number_format($mem->total_income);?></td>
                                            <td class="center"><?php echo number_format($mem->total_encashed);?></td>
                                            <td class="center"><?php echo number_format($mem->balance);?></td>
                                            <td class="center"><?php echo number_format($converted);?></td>
                                        </tr>
