...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/dxn/library/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/dxn/library/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">

	<link href="<?php echo base_url();?>assets/new-capture-page-assets/dxn/style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/dxn/css/custom-style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/dxn/css/media-queries.css" rel="stylesheet">
</head>
<body>
        ...
        <div class="content_holder"><!-- Begin content -->
			<div class="row-fluid">
				<div class="span12" style="text-align:center;">
					...
					<div class="rowpush" style="height:40px;"></div>
					<img src="<?php echo base_url();?>assets/new-capture-page-assets/dxn/images/logo.jpg" alt="logo">
					<div class="rowpush" style="height:40px;"></div>
					<div id="ytb_vid"></div>
					<img id="ytb"  src="<?php echo base_url();?>assets/new-capture-page-assets/dxn/images/video.jpg" width="621" height="374" alt="top">
					<br />
					<br />
...
<script src="<?php echo base_url();?>assets/new-capture-page-assets/dxn/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url();?>assets/new-capture-page-assets/dxn/library/bootstrap/js/bootstrap.min.js"></script>
