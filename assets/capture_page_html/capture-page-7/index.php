...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/library/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/library/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">

	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/css/custom-style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/css/media-queries.css" rel="stylesheet">
</head>
<body>
...
?>
	...
	<input type="hidden" value="<?php echo $capture_page_id?>" name="capture_page_id" id="capture_page_id">
            <div class="content_holder"><!-- Begin content -->
				<div class="row-fluid">
					<div id="ytb_vid1"></div>
					<div class="span3"><img id="ytv1" src="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/images/logo.png" width="239" height="198" alt="Logo"></div>
				...
				<div class="row-fluid">
					<div class="span6" style="text-align:center;">
						...
						<div class="row-fluid">
							<div class="span12">
							<div id="ytb_vid1"></div>
								<img id="ytv1" src="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/images/video.jpg" width="460" height="" alt="video">
							</div><!-- //End span12 -->
						</div><!-- //End row-fluid -->
	...
	<div class="container">
        <div class="content_wrapper">
            <div class="content_holder"><!-- Begin content -->
				<div class="row-fluid">
					<div class="span6">
						<h1 style="color:#000; text-align:center;">NOW ACCEPTING AREA DISTRIBUTOR AND FRANCHISEE</h1>
					</div><!-- //End span12 -->
					<div class="span6">
					</div><!-- //End span12 -->
				</div><!-- //End row-fluid -->
...
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/library/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-7/js/script.js"></script>
</body>
</html>