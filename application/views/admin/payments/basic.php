...
<head>
    ...
    <title>Payments>Basic | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i> Basic
                        </div>
                        <!-- /.panel-heading -->
                      ...
                      if(!empty($getPayment)){
									...
									?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td align="center"><span id="span_wait1<?php echo $payment_id;?>"></span><?php echo ($status==0 ? '<a href="javascript:void();" class="approval approvalhide_'.$payment_id.'" id="'.$payment_id.'"><input type="hidden" value="'.$payment_id.'" id="payment_id" name="payment_id"><input type="hidden" value="'.$member_id.'" id="member_id" name="member_id">Approve</a>' : '---');?>  <?php echo ($status==0 ? '<a href="javascript:void();" class="disapprove disapprovehide_'.$payment_id.'" id="'.$payment_id.'"><input type="hidden" value="'.$payment_id.'" id="payment_id" name="payment_id"><input type="hidden" value="'.$member_id.'" id="member_id" name="member_id">Disapprove</a>' : '---');?> </td>
                                        </tr>
