...
<head>
    ...
    <title>Transfer>Remitance History | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i>Remitance History
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           <div class="table-responsive">
                                 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                     <?php
                                    if(!empty($remithistory)){
										foreach($remithistory as $request){
										/*	echo '<pre>';
											print_r($request);
											echo '</pre>';*/
