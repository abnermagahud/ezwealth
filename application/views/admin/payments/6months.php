...
<head>
    ...
    <title>Payments>6 Months | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i> Six Months
                        </div>
                        <!-- /.panel-heading -->
                       ...
                       $proof_of_payment = $subscription->proof_of_payment;
									...
									?>
                                           ...
                                           <td class="center" width="40" align="center"><a id="hash1" data-container="body" data-trigger="hover" data-placement="left" data-content="<?php echo nl2br($notes);?>"><span class="glyphicon glyphicon-list-alt"></span></a></td>
                                           
                                            <td align="center"><span id="span_wait<?php echo $payment_id;?>"></span><?php echo ($status==0 ? '<a href="javascript:void();" class="approval_months approvalhide_'.$payment_id.'" id="'.$payment_id.'"><input type="hidden" value="'.$payment_id.'" id="payment_id" name="payment_id"><input type="hidden" value="'.$member_id.'" id="member_id" name="member_id">Approve</a>' : '---');?> <?php echo ($status==0 ? '<a href="javascript:void();" class="disapprove_months disapprovehide_'.$payment_id.'" id="'.$payment_id.'"><input type="hidden" value="'.$payment_id.'" id="payment_id" name="payment_id"><input type="hidden" value="'.$member_id.'" id="member_id" name="member_id">Disapprove</a>' : '---');?></td>
                                        </tr>
                                        <?php
										}
									}
