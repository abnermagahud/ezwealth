...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-20/library/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-20/library/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">

	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-20/style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-20/css/custom-style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-20/css/media-queries.css" rel="stylesheet">
</head>
<body>
...
?>
	...
	<input type="hidden" value="<?php echo $capture_page_id?>" name="capture_page_id" id="capture_page_id">
            <div class="content_holder"><!-- Begin content -->
				<div class="rowpush" style="height:10px;"></div>
            ...
            <div class="content_holder"><!-- Begin content -->
				...
				<div class="row-fluid">
					...
					<div class="span6">
						<div class="form">
						<form method="post">
							<p class="form-heading">FIND YOUR DREAM HOME</p>
...
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-20/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-20/library/bootstrap/js/bootstrap.min.js"></script>
