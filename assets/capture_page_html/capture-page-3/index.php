...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/library/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/library/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">

	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/css/custom-style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/css/media-queries.css" rel="stylesheet">
</head>
<body>
...
?>
	...
	<input type="hidden" value="<?php echo $capture_page_id?>" name="capture_page_id" id="capture_page_id">
        <div class="content_wrapper">
            ...
            <div class="content_holder" style="text-align:center;"><!-- Begin content -->
				<h3 style="line-height:1;color:#000;">NO <span style="color:#ff3c02;">EXPERIENCE</span>, <span style="color:#ff3c02;">MONEY</span> OR <span style="color:#ff3c02;">WEBSITE</span> NEEDED!</h3>
...
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/library/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-3/js/script.js"></script>
</body>
</html>