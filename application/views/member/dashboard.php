...
<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                  <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a  class="active" href="<?php echo base_url();?>member/"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
        ...
        <br />
            <div class="row" align="center">
                    <iframe width="100%" height="500" src="//www.youtube.com/embed/I1Ee0auMr8I?rel=0&autoplay=1&loop=1&showinfo=0&controls=0" frameborder="0" allowfullscreen=""></iframe>
