...
<head>
    ...
    <title>Control>Announcement | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i>Announcement
                            <div class="pull-right" style="margin-top:-7px;">
                          <button type="button" data-toggle="modal" data-target="#modal" class="btn btn-primary" name="Add Announcent" id="add_announcement"><i class="fa fa-plus fa-fw"></i>Add Announcement</button>
                            </div>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="content" width="100%">
                                    <thead>
                                        <tr>
                                   ...
                                   if(!empty($announcements)){
									...
									?>
                                        <tr class="odd gradeX record">
                                            ...
                                            <td width="120"><a href="<?php echo base_url();?>admin/edit-announcement/<?php echo $announcement->announcement_id;?>/">Edit</a> | <a href="javascript:void(0);" id="<?php echo $announcement->announcement_id;?>"class="delannouncement"><input type="hidden" value="<?php echo $announcement->announcement_id;?>" name="announcement_id">Delete</a></td>
                                        </tr>
                                     <?php
...
<div id="message_add_announcement"></div>
  ...
  <div class="form-group">
    ...
    <div class="modal-footer">
       ...
       <button type="button" class="btn btn-primary" id="btn_announcement"onClick="addAnnouncement()">Add Announcement</button>
      </div>  
    </div>
    </form>
  </div>
