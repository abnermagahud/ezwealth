...
<head>
    ...
    <title>Transfer>Bank Request | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i>Bank Request
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>Username</th>
                                            <th>Fullname</th>
                                            <th width="120">Mode of Transfer</th>
                                    ...
                                    if(!empty($bankrequest)){
										foreach($bankrequest as $request){
										/*	echo '<pre>';
											print_r($request);
											echo '</pre>';*/
									...
									?>
                                        <tr class="odd gradeX record">
                                            ...
                                            <td width="120" align="center"><?php echo $transfer_mode;?></td>
                                            <td class="center" width="70"><?php echo $processor;?></td>
                                             <td class="center" width="200"><?php echo $account_no;?></td>
                                            <td class="center" width="50"><?php echo $amount;?></td>
                                            <td class="center"><span id="span_wait3"></span><a href="javascript:void(0);" id="<?php echo $transfer_id;?>" class="transfer_bank"><input type="hidden" value="<?php echo $transfer_id;?>" id="transfer_id" name="transfer_id">Transfer</a></td>
                                        </tr>
                                    </tbody>
