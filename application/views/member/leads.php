...
<div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo base_url();?>member/leads/"><i class="fa fa-bar-chart-o fa-fw"></i> Leads</a>
                    </li>
                      <li>
            ...
            <div class="row">
                <div class="panel panel-default">
                        <div class="panel-heading">
                          <i class="fa fa-bar-chart-o fa-fw"></i> Leads
                        </div>
                        <!-- /.panel-heading -->
				 ...
				 ?>   
              	  ...
              	  <table width="100%" class="table table-responsive table-hover" border="0" id="examples">
                         <thead>
                          <tr>
                     		<th>#</th>
                            <th>Email</th>
   ...
   <a href="<?php echo base_url();?>member/exportToExcel/">Export to excel</a>         
<?php
}
?>
                     </div>
