...
<head>
    ...
    <title>Leads | Administration Panel</title>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="<?php echo base_url();?>admin/bank_history/">BANK HISTORY </a></li>
                    ...
                    <li class="dropdown">
          			...
          			<li class="active"><a href="<?php echo base_url();?>admin/leads/">LEADS</a></li> 
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i>Leads
                        </div>
                        <!-- /.panel-heading -->
                           ...
                           <div class="table-responsive">
                                 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(!empty($leads)){
										...
										$ref_fname = $lead->firstname;
										$ref_lname = $lead->lastname;
									?>
                                        <tr class="odd gradeX">
                                       		 <td><?php echo $counter++;?></td>
                                            <td><?php echo ucwords($ref_fname.' '. $ref_lname);?></td>
                                            <td><?php echo $lead->email?></td>
                                            <td><?php echo $lead->contact_num;?></td>
                                        </tr>
                                        <?php
										}
                                ...
                                <br />
                                <a href="<?php echo base_url();?>admin/toExcel/">Export to excel</a>
                                </div> 
