...
<head>
    ...
    <title>E-Credit>E-Credit Request | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i>E-Credit Requests
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="center" align="center" width="150"><div align="center">Actions</div></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                  				<?php
                   					if(!empty($ecredits)){
										foreach($ecredits as $request){
										  $buyecredit_id     = $request->buyecredit_id;
                      ...
                      $notes = $request->notes;
									?>
                                        <tr class="gradeX">
                                            ...
                                            <td><a href="<?php echo base_url();?>uploads/<?php echo $image;?>" data-toggle="lightbox"><?php echo $image;?></a></td>
                                            <td align="center"><a id="hash1" data-container="body" data-trigger="hover" data-placement="left" data-content="<?php echo nl2br($notes);?>"><span class="glyphicon glyphicon-list-alt"></span></a></td>
                                            <td align="center"><span id="wait_ecredit<?php echo $buyecredit_id;?>">
                                            <?php if($payment_status!=1):?>
                                            <a href="javascript:void(0);" id="<?php echo $buyecredit_id;?>,<?php echo $member_id; ?>,<?php echo $amount;?>" class="approval_ecredit approveecredithide_<?php echo $buyecredit_id;?>">Approve</a> 
                                            <?php else:?> 
                                            -----
                                            <?php endif;?>
                                            <?php if($payment_status!=1):?>
                                            <a href="javascript:void(0);" class="disapprove_ecredit disapproveecredithide_<?php echo $buyecredit_id;?>" id="<?php echo $buyecredit_id;?>"><input type="hidden" value="<?php echo $buyecredit_id;?>" name="buyecredit_id"><input type="hidden" value="<?php echo $member_id;?>" name="member_id">Disapprove</a>
                                            <?php else:?> 
                                            ------
                                            <?php endif;?>
                                            </td>
...
<div class="modal fade" id="modal-approval" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="myModalLabel">E-Credit Approval</h4>
      </div>
      <div class="modal-body">
       <div id="wait-approval"></div>
      <div id="messages-approval"></div>
        <form class="form-horizontal" method="post">
                 <div class="form-group">
                     <label class="col-sm-3 control-label"><strong>Enter Amount</strong></label>
                   <div class="col-md-7">
            <input type="hidden"  class="form-control" name="datas" id="datas"  />    
           <input type="text"  class="form-control" style="height:32px;" name="amount" id="amount"  />
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" id="btn-approve-credit1" onClick="approve_ecredit()">Approve</button>
      </div>
    </div>
  </div>
</div>
...
<script>
    $(document).ready(function() {
     ...
     $('[id=hash1]').popover({ trigger: "hover" });   
    });
    </script>
</body>
