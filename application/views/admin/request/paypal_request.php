...
<head>
    ...
    <title>Transfer>Paypal Request | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i>Paypal Request
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           ...
                           <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(!empty($paypalrequest)){
										foreach($paypalrequest as $request){
											/*echo '<pre>';
											print_r($request);
											echo '</pre>';*/
									...
									?>
                                        <tr class="odd gradeX record">
                                            ...
                                            <td class="center"><a href="javascript:void(0);" id="<?php echo $transfer_id;?>" class="transfer_paypal"><input type="hidden" value="<?php echo $transfer_id;?>" id="transfer_id" name="transfer_id">Transfer</a></td>
                                        </tr>
                                        <?php
                                        		}
										}
