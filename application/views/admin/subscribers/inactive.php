...
<head>
    ...
    <title>Subscribers>Inactive | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i> Inactive Subscribers
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(!empty($inactivemembers)){
                  										foreach($inactivemembers as $member){
                  											...
                  											$member_fullname = $firstname.' '.$lastname;
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo ucwords($member_fullname);?></td>
                                            <td class="center"><?php echo $email;?></td>
                                            <td class="center"><?php echo $mobile_number;?></td>
                                            <td class="center"><?php echo $registration_date;?></td>
                                            <td class="center"><span id="wait-activate-free<?php echo $member_id;?>"></span><div id="div-activate-free<?php echo $member_id;?>"><a href="javascript:void(0);" id="<?php echo $member_id;?>" class="activate-free-basic">Basic</a> | <a href="javascript:void(0);" id="<?php echo $member_id;?>" class="activate-free-premium">Premium</a></div></td>
                                        </tr>
                                        <?php
                                        		}
                      										}
