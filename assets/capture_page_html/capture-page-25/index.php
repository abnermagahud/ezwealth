...
<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-25/style.css" rel="stylesheet">

</head>
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<input type="hidden" value="<?php echo base_url();?>" id="baseurl" name="baseurl">
<!-- Save for Web Slices (stpeter grid.psd) -->
<form method="post">
...
?>
	...
	<input type="hidden" value="<?php echo $capture_page_id?>" name="capture_page_id" id="capture_page_id">
			<img src="<?php echo base_url();?>assets/capture_page_assets/capture-page-25/images/index_01.png" width="1263" height="195" alt=""></td>
	</tr>
	<tr>
		<td rowspan="2">
			<img src="<?php echo base_url();?>assets/capture_page_assets/capture-page-25/images/index_02.png" width="722" height="700" alt=""></td>
			
		<td class="form" style="background:#199a00; text-align:center; vertical-align:top; padding:20px 40px 20px 40px;" width="382" height="372">
		...
		<td rowspan="2">
			<img src="<?php echo base_url();?>assets/capture_page_assets/capture-page-25/images/index_04.png" width="159" height="700" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="<?php echo base_url();?>assets/capture_page_assets/capture-page-25/images/index_05.png" width="382" height="328" alt=""></td>
	</tr>
</table>
