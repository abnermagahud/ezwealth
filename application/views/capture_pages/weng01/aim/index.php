...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/aim/library/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/aim/library/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">

	<link href="<?php echo base_url();?>assets/new-capture-page-assets/aim/style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/aim/css/custom-style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/new-capture-page-assets/aim/css/media-queries.css" rel="stylesheet">
</head>
<body>

<div class="container">
    <div class="content_wrapper" style="background:#000000;">
        ...
        <div class="content_holder"><!-- Begin content -->
			<div class="row-fluid">
				<div class="span12" style="text-align:center;">
					<img src="<?php echo base_url();?>assets/new-capture-page-assets/aim/images/top.jpg" alt="top">
					<div class="rowpush" style="height:40px;"></div>
					<h1>Alliance in Motion Global Please Watch the Video</h1>
					<div class="rowpush" style="height:40px;"></div>
					<div id="ytb_vid"></div>
					<img id="ytb" src="<?php echo base_url();?>assets/new-capture-page-assets/aim/images/video.jpg" width="621" height="374" alt="top">
					<br />
					<br />
					...
					<div class="rowpush" style="height:40px;"></div>
					<img src="<?php echo base_url();?>assets/new-capture-page-assets/aim/images/bottom.jpg" alt="bottom">
				</div><!-- End span12 -->
			</div><!-- End row-fluid -->
...
<script src="<?php echo base_url();?>assets/new-capture-page-assets/aim/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url();?>assets/new-capture-page-assets/aim/library/bootstrap/js/bootstrap.min.js"></script>
