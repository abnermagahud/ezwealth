...
<div class="canvass">
 ...
 <div id="error"><span style="clear:both;">| <a href="<?php echo base_url();?>">HOME</a> | <a href="<?php echo base_url();?>products/">PRODUCTS</a> | <a href="<?php echo base_url();?>faq/">F.A.Q.</a> | <a href="<?php echo base_url();?>contact-us/">CONTACT US</a> |</span></div>
...
<input class="form-control" id="referred_by" name="referred_by"  value="ezwealth" type="text" placeholder="You were referred by" readonly/>
</div>
</div>
<span class="clearfix"></span>
 <div class="col-md-12 form-group">
<input type="button" name="btn_continue" id="btn_createaccount" onClick="create_account()" value="Continue" class="btn form-control" style="background-color:#0F6; font-weight:bold;"/>
</div>
...
<div class="modal fade" id="myModalJoin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <strong>Username:</strong> <span id="span_username1"></span><br />
            <strong>Password:</strong> <span id="span_password1"></span><br />
           <strong> Referrer:</strong> <span id="span_referrer1"></span><br /><br />
