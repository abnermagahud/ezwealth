...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/library/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/library/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">

	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/css/custom-style.css" rel="stylesheet">
	<link href="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/css/media-queries.css" rel="stylesheet">
</head>
<body>
	...
	<input type="hidden" value="<?php echo $capture_page_id?>" name="capture_page_id" id="capture_page_id">
            <div class="content_holder"><!-- Begin content -->
				...
				<div class="row-fluid">
					...
					<div class="span6"><img src="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/images/logo.jpg" alt="logo"></div><!-- //End span6 -->
					<div class="span3"></div><!-- //End span3 -->
				</div><!-- //End row-fluid -->
...
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/library/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php echo base_url();?>assets/capture_page_assets/capture-page-9/js/script.js"></script>
</body>
</html>