...
<head>
    ...
    <title>E-Credit>E-Credit Coversion History | Administration Panel</title>
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i>E-credit Conversion History
                        </div>
                        <!-- /.panel-heading -->
              ...
              <?php
                                    ...
                                    if(!empty($ecredithistory)){
                                    
										foreach($ecredithistory as $history){
