...
<head>
    ...
    <title>Subscribers>Active | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i> Active Subscriber
                        </div>
                        <!-- /.panel-heading -->
								...
								$this->load->model('admin_model');
                                    if(!empty($members)){
										...
										foreach($members as $member){
											...
											$account_no = $member->account_number;
									...
									?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $email;?></td>
                                             <td class="center"><?php echo $account_no;?></td>
                                            <td class="center"><?php echo $mobile_number;?></td>
                                            <td class="center"><?php echo $registration_date;?></td>
                                            <td class="center"><?php echo $activation_date;?></td>
                                            <td class="center"><?php echo $expiration_date;?></td>
                                            <td class="center"><?php echo $this->admin_model->getMemberLeads($member_id)?></td>
                                        </tr>
                                        <?php
                                        	}
										}
