...
<head>
    ...
    <title>Payments>One Year | Administration Panel</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-users fa-fw"></i> One Year
                        </div>
                        <!-- /.panel-heading -->
									...
									?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $payment_mode;?></td>
                                             <td class="center"><a href="<?php echo base_url();?>uploads/<?php echo $proof_of_payment;?>"  data-toggle="lightbox"><?php echo $proof_of_payment;?></a></td>
                                            <td class="center"><?php echo $processor;?></td>
                                           
                                            <td class="center"><?php echo $reference_number;?></td>
                                            <td class="center"><?php echo $sender_name;?></td>
                                            <td class="center" width="40" align="center"><a id="hash2" data-container="body" data-trigger="hover" data-placement="left" data-content="<?php echo nl2br($notes);?>"><span class="glyphicon glyphicon-list-alt"></span></a></td>
                                           
                                            <td align="center"><span id="span_wait2<?php echo $payment_id;?>"></span><?php echo ($status==0 ? '<a href="javascript:void();" class="approval_year approveyearhide_'.$payment_id.'" id="'.$payment_id.'"><input type="hidden" value="'.$payment_id.'" id="payment_id" name="payment_id"><input type="hidden" value="'.$member_id.'" id="member_id" name="member_id">Approve</a>' : '---');?> <?php echo ($status==0 ? '<a href="javascript:void();" class="disapprove_year disapproveyearhide_'.$payment_id.'" id="'.$payment_id.'"><input type="hidden" value="'.$payment_id.'" id="payment_id" name="payment_id"><input type="hidden" value="'.$member_id.'" id="member_id" name="member_id">Disapprove</a>' : '---');?></td>
                                        </tr>
                                        <?php
...
<script>
	...
	$('[id=hash2]').popover({ trigger: "hover" });
    });
    </script>
</body>
